          ...
          {Array.from({ length: OTP_LENGTH }).map((_, i) => (
            <div key={i} className="flex-1">
              <input
                ...
                autoFocus={i === 0}
                className={`w-full h-14 sm:h-16 text-center text-[22px] sm:text-2xl font-black rounded-xl sm:rounded-2xl outline-none transition-all duration-200 ${isThemed
